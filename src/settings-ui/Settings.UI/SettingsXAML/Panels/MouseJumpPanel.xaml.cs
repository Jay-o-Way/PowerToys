...
namespace Microsoft.PowerToys.Settings.UI.Panels
{
    public sealed partial class MouseJumpPanel : UserControl
    {
        ...
        private void PreviewTypeSetting_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            var selectedPreviewType = GetSelectedPreviewType();
            var customPreviewTypeSelected = selectedPreviewType == PreviewType.Custom;
            CopyStyleToCustom.IsEnabled = !customPreviewTypeSelected;
            var customControlVisibility = customPreviewTypeSelected
                ? Visibility.Visible
                : Visibility.Collapsed;
            MouseUtils_MouseJump_BackgroundColor1.Visibility = customControlVisibility;
            MouseUtils_MouseJump_BackgroundColor2.Visibility = customControlVisibility;
            MouseUtils_MouseJump_BorderThickness.Visibility = customControlVisibility;
            MouseUtils_MouseJump_BorderColor.Visibility = customControlVisibility;
            MouseUtils_MouseJump_Border3dDepth.Visibility = customControlVisibility;
            MouseUtils_MouseJump_BorderPadding.Visibility = customControlVisibility;
            MouseUtils_MouseJump_BezelThickness.Visibility = customControlVisibility;
            MouseUtils_MouseJump_BezelColor.Visibility = customControlVisibility;
            MouseUtils_MouseJump_Bezel3dDepth.Visibility = customControlVisibility;
            MouseUtils_MouseJump_ScreenMargin.Visibility = customControlVisibility;
            MouseUtils_MouseJump_ScreenColor1.Visibility = customControlVisibility;
            MouseUtils_MouseJump_ScreenColor2.Visibility = customControlVisibility;
        }
        ...
        private /* async */ void CopyStyleToCustom_Click(object sender, RoutedEventArgs e)
        {
            ...
            */
            MouseUtils_MouseJump_CopyToCustomStyle_MessageBox_PrimaryButtonCommand();
        }
        ...
        private void MouseUtils_MouseJump_CopyToCustomStyle_MessageBox_PrimaryButtonCommand()
        {
            ...
            ViewModel.MouseJumpPreviewType = selectedPreviewType.ToString();
            ViewModel.MouseJumpBackgroundColor1 = ConfigHelper.SerializeToConfigColorString(
                ConfigHelper.ToUnnamedColor(selectedPreviewStyle.CanvasStyle.BackgroundStyle.Color1));
            ViewModel.MouseJumpBackgroundColor2 = ConfigHelper.SerializeToConfigColorString(
                ConfigHelper.ToUnnamedColor(selectedPreviewStyle.CanvasStyle.BackgroundStyle.Color2));
            ViewModel.MouseJumpBorderThickness = (int)selectedPreviewStyle.CanvasStyle.BorderStyle.Top;
            ViewModel.MouseJumpBorderColor = ConfigHelper.SerializeToConfigColorString(
                ConfigHelper.ToUnnamedColor(selectedPreviewStyle.CanvasStyle.BorderStyle.Color));
            ViewModel.MouseJumpBorder3dDepth = (int)selectedPreviewStyle.CanvasStyle.BorderStyle.Depth;
            ViewModel.MouseJumpBorderPadding = (int)selectedPreviewStyle.CanvasStyle.PaddingStyle.Top;
            ViewModel.MouseJumpBezelThickness = (int)selectedPreviewStyle.ScreenStyle.BorderStyle.Top;
            ViewModel.MouseJumpBezelColor = ConfigHelper.SerializeToConfigColorString(
                ConfigHelper.ToUnnamedColor(selectedPreviewStyle.ScreenStyle.BorderStyle.Color));
            ViewModel.MouseJumpBezel3dDepth = (int)selectedPreviewStyle.ScreenStyle.BorderStyle.Depth;
            ViewModel.MouseJumpScreenMargin = (int)selectedPreviewStyle.ScreenStyle.MarginStyle.Top;
            ViewModel.MouseJumpScreenColor1 = ConfigHelper.SerializeToConfigColorString(
                ConfigHelper.ToUnnamedColor(selectedPreviewStyle.ScreenStyle.BackgroundStyle.Color1));
            ViewModel.MouseJumpScreenColor2 = ConfigHelper.SerializeToConfigColorString(
        ...
        private PreviewType GetSelectedPreviewType()
        {
            ...
            var selectedIndex = PreviewTypeSetting.SelectedIndex;
